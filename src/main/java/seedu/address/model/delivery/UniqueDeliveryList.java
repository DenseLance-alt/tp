 ...
 * A delivery is considered unique by comparing using {@code Delivery#isSameDelivery(Delivery)}. As such, adding
 * and updating of deliveries uses Delivery#isSameDelivery(Delivery) for equality so as to ensure that the delivery
 * being added or updated is unique in terms of identity in the UniqueDeliveryList. However, the removal of a delivery
 * uses Delivery#equals(Object) so as to ensure that the person with exactly the same fields will be removed.
 *
...
public class UniqueDeliveryList implements Iterable<Delivery> {
     ...
     * The {@code editedDelivery} must not be the same as another existing delivery in the list.
     */
